...
namespace Dynamics
{
    public static class DynamicsSetupUtil
    {
        ...
        public static void SetupDynamics(IConfiguration Configuration)
        {
            ...
            var handler = new HttpClientHandler { Credentials = serviceClientCredentials };

            var httpClient = new HttpClient(handler);

            DynamicsClient client = new DynamicsClient( httpClient );
            ...
            {
                client.BaseUrl = Configuration["DYNAMICS_ODATA_URI"];
            }
            else
            {
                client.BaseUrl = Configuration["DYNAMICS_NATIVE_ODATA_URI"];
            }
